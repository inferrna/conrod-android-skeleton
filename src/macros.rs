...
///
/// Expects a `conrod_core::cursor::MouseCursor`, returns a `winit::event::MouseCursor`.
///
/// Requires that both the `conrod_core` and `winit` crates are in the crate root.
#[macro_export]
macro_rules! convert_mouse_cursor {
    ($cursor:expr) => {{
        match $cursor {
            conrod_core::cursor::MouseCursor::Text => winit::event::MouseCursor::Text,
            conrod_core::cursor::MouseCursor::VerticalText => winit::event::MouseCursor::VerticalText,
            conrod_core::cursor::MouseCursor::Hand => winit::event::MouseCursor::Hand,
            conrod_core::cursor::MouseCursor::Grab => winit::event::MouseCursor::Grab,
            conrod_core::cursor::MouseCursor::Grabbing => winit::event::MouseCursor::Grabbing,
            conrod_core::cursor::MouseCursor::ResizeVertical => winit::event::MouseCursor::NsResize,
            conrod_core::cursor::MouseCursor::ResizeHorizontal => winit::event::MouseCursor::EwResize,
            conrod_core::cursor::MouseCursor::ResizeTopLeftBottomRight => {
                winit::event::MouseCursor::NwseResize
            }
            conrod_core::cursor::MouseCursor::ResizeTopRightBottomLeft => {
                winit::event::MouseCursor::NeswResize
            }
            _ => winit::event::MouseCursor::Arrow,
        }
    }};
}
